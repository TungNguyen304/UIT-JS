...
function sendMsgForLeft() {
    if (inputLeft.value) {
        msgStoreLeft.push(`<div class='msg msg__right'><span style='font-style:${inputLeft.style.fontStyle || ""}; font-weight:${inputLeft.style.fontWeight || ""}'>${inputLeft.value}</span></div>`);
        msgStoreRight.push(`<div class='msg msg__left'><span style='font-style:${inputLeft.style.fontStyle || ""}; font-weight:${inputLeft.style.fontWeight || ""}'>${inputLeft.value}</span></div>`);
...
function sendMsgForRight() {
    if (inputRight.value) {
        msgStoreLeft.push(`<div class='msg msg__left'><span style='font-style:${inputRight.style.fontStyle || ""}; font-weight:${inputRight.style.fontWeight || ""}'>${inputRight.value}</span></div>`);
        msgStoreRight.push(`<div class='msg msg__right'><span style='font-style:${inputRight.style.fontStyle || ""}; font-weight:${inputRight.style.fontWeight || ""}'>${inputRight.value}</span></div>`);
        screenLeft.innerHTML = msgStoreLeft.join(' ');
        screenRight.innerHTML = msgStoreRight.join(' ');
        inputRight.value = '';
        inputRight.focus();
